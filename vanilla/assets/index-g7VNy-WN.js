(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e={},t=t=>{let n=e[t.type];if(n)for(let[e,r]of Object.entries(n)){let n=t.target.closest(e);if(n)try{r(t)}catch(t){console.error(`이벤트 핸들러 실행 오류 (${e}):`,t)}}},n=(()=>()=>{Object.keys(e).forEach(e=>{document.body.addEventListener(e,t)})})(),r=(t,n,r)=>{e[t]||(e[t]={}),e[t][n]=r},i=(e=200)=>{let t=window.pageYOffset||document.documentElement.scrollTop,n=window.innerHeight,r=document.documentElement.scrollHeight;return t+n>=r-e},a=e=>{let t=!1;return(...n)=>{t||(t=!0,queueMicrotask(()=>{t=!1,e(...n)}))}},o={SET_PRODUCTS:`products/setProducts`,ADD_PRODUCTS:`products/addProducts`,SET_LOADING:`products/setLoading`,SET_ERROR:`products/setError`,SET_CATEGORIES:`products/setCategories`,SET_CURRENT_PRODUCT:`products/setCurrentProduct`,SET_RELATED_PRODUCTS:`products/setRelatedProducts`,RESET_FILTERS:`products/resetFilters`,SETUP:`products/setup`,SET_STATUS:`products/setStatus`},s={ADD_ITEM:`cart/addItem`,REMOVE_ITEM:`cart/removeItem`,UPDATE_QUANTITY:`cart/updateQuantity`,CLEAR_CART:`cart/clearCart`,TOGGLE_SELECT:`cart/toggleSelect`,SELECT_ALL:`cart/selectAll`,DESELECT_ALL:`cart/deselectAll`,REMOVE_SELECTED:`cart/removeSelected`,LOAD_FROM_STORAGE:`cart/loadFromStorage`,SYNC_TO_STORAGE:`cart/syncToStorage`},c={OPEN_CART_MODAL:`ui/openCartModal`,CLOSE_CART_MODAL:`ui/closeCartModal`,SET_GLOBAL_LOADING:`ui/setGlobalLoading`,SHOW_TOAST:`ui/showToast`,HIDE_TOAST:`ui/hideToast`},l=()=>{let e=new Set,t=t=>e.add(t),n=()=>e.forEach(e=>e());return{subscribe:t,notify:n}},u=(e,t)=>{let{subscribe:n,notify:r}=l(),i=t,a=()=>i,o=t=>{let n=e(i,t);n!==i&&(i=n,r())};return{getState:a,dispatch:o,subscribe:n}},d=(e,t)=>{let n=(()=>{let e=new Map;return{getItem:t=>e.has(t)?e.get(t):null,setItem:(t,n)=>e.set(t,n),removeItem:t=>e.delete(t)}})(),r=t??(typeof window<`u`&&window?.localStorage?window.localStorage:n),i=()=>{try{let t=r.getItem(e);return t?JSON.parse(t):null}catch(t){return console.error(`Error parsing storage item for key "${e}":`,t),null}},a=t=>{try{r.setItem(e,JSON.stringify(t))}catch(t){console.error(`Error setting storage item for key "${e}":`,t)}},o=()=>{try{r.removeItem(e)}catch(t){console.error(`Error removing storage item for key "${e}":`,t)}};return{get:i,set:a,reset:o}};var f=class e{#routes;#route;#observer=l();#baseUrl;constructor(e=``){this.#routes=new Map,this.#route=null,this.#baseUrl=e.replace(/\/$/,``),window.addEventListener(`popstate`,()=>{this.#route=this.#findRoute(),this.#observer.notify()})}get baseUrl(){return this.#baseUrl}get query(){return e.parseQuery(window.location.search)}set query(t){let n=e.getUrl(t,this.#baseUrl);this.push(n)}get params(){return this.#route?.params??{}}get route(){return this.#route}get target(){return this.#route?.handler}subscribe(e){this.#observer.subscribe(e)}addRoute(e,t){let n=[],r=e.replace(/:\w+/g,e=>(n.push(e.slice(1)),`([^/]+)`)).replace(/\//g,`\\/`),i=RegExp(`^${this.#baseUrl}${r}$`);this.#routes.set(e,{regex:i,paramNames:n,handler:t})}#findRoute(e=window.location.pathname){let{pathname:t}=new URL(e,window.location.origin);for(let[e,n]of this.#routes){let r=t.match(n.regex);if(r){let t={};return n.paramNames.forEach((e,n)=>{t[e]=r[n+1]}),{...n,params:t,path:e}}}return null}push(e){try{let t=e.startsWith(this.#baseUrl)?e:this.#baseUrl+(e.startsWith(`/`)?e:`/`+e),n=`${window.location.pathname}${window.location.search}`;n!==t&&window.history.pushState(null,``,t),this.#route=this.#findRoute(t),this.#observer.notify()}catch(e){console.error(`라우터 네비게이션 오류:`,e)}}start(){this.#route=this.#findRoute(),this.#observer.notify()}static parseQuery=(e=window.location.search)=>{let t=new URLSearchParams(e),n={};for(let[e,r]of t)n[e]=r;return n};static stringifyQuery=e=>{let t=new URLSearchParams;for(let[n,r]of Object.entries(e))r!=null&&r!==``&&t.set(n,String(r));return t.toString()};static getUrl=(t,n=``)=>{let r=e.parseQuery(),i={...r,...t};Object.keys(i).forEach(e=>{(i[e]===null||i[e]===void 0||i[e]===``)&&delete i[e]});let a=e.stringifyQuery(i);return`${n}${window.location.pathname.replace(n,``)}${a?`?${a}`:``}`}},p=class e{#routes;#route;#baseUrl;constructor(e=``){this.#routes=new Map,this.#route=null,this.#baseUrl=String(e).replace(/\/$/,``)}get baseUrl(){return this.#baseUrl}get route(){return this.#route}get params(){return this.#route?.params??{}}get target(){return this.#route?.handler}get query(){return this.#route?.query??{}}addRoute(e,t){let n=[],r=e.replace(/:\w+/g,e=>(n.push(e.slice(1)),`([^/]+)`)).replace(/\//g,`\\/`),i=RegExp(`^${r}$`);this.#routes.set(e,{regex:i,paramNames:n,handler:t})}match(t){let n=new URL(t,`http://localhost`),r=n.pathname,i=n.search;for(let[t,n]of this.#routes){let a=r.match(n.regex);if(a){let r={};n.paramNames.forEach((e,t)=>{r[e]=a[t+1]});let o=e.parseQuery(i);return{...n,params:r,query:o,path:t}}}return null}resolve(e){return this.#route=this.match(this.#stripBase(e)),this.#route}#stripBase(e){if(!this.#baseUrl)return e;let t=new URL(e,`http://localhost`),n=t.pathname.replace(this.#baseUrl,``)+t.search+t.hash;return n||`/`}static parseQuery(e=``){let t=new URLSearchParams(e.startsWith(`?`)?e:e?`?${e}`:``),n={};for(let[e,r]of t)r!==``&&r!=null&&(n[e]=r);return n}},m=class{#instance;#baseUrl;constructor(e=``){this.#instance=null,this.#baseUrl=String(e).replace(/\/$/,``)}#isServer(){try{return typeof window>`u`||!1}catch{return!0}}#ensure(){return this.#instance||=this.#isServer()?new p(this.#baseUrl):new f(this.#baseUrl),this.#instance}get baseUrl(){return this.#baseUrl}get route(){return this.#ensure().route??null}get params(){return this.#ensure().params??{}}get target(){return this.#ensure().target}get query(){return this.#ensure().query??{}}set query(e){let t=this.#ensure();try{t.query=e}catch{}}addRoute(e,t){this.#ensure().addRoute(e,t)}match(e){let t=this.#ensure();if(typeof t.match==`function`)return t.match(e);throw Error(`UniversalRouter.match() is server-only`)}resolve(e){let t=this.#ensure();if(typeof t.resolve==`function`)return t.resolve(e);throw Error(`UniversalRouter.resolve() is server-only`)}push(e){let t=this.#ensure();typeof t.push==`function`&&t.push(e)}start(){let e=this.#ensure();typeof e.start==`function`&&e.start()}subscribe(e){let t=this.#ensure();typeof t.subscribe==`function`&&t.subscribe(e)}};const h={products:[],totalCount:0,currentProduct:null,relatedProducts:[],loading:!0,error:null,status:`idle`,categories:{}},ee=(e,t)=>{switch(t.type){case o.SET_STATUS:return{...e,status:t.payload};case o.SET_CATEGORIES:return{...e,categories:t.payload,loading:!1,error:null,status:`done`};case o.SET_PRODUCTS:return{...e,products:t.payload.products,totalCount:t.payload.totalCount,loading:!1,error:null,status:`done`};case o.ADD_PRODUCTS:return{...e,products:[...e.products,...t.payload.products],totalCount:t.payload.totalCount,loading:!1,error:null,status:`done`};case o.SET_LOADING:return{...e,loading:t.payload};case o.SET_ERROR:return{...e,error:t.payload,loading:!1,status:`done`};case o.SET_CURRENT_PRODUCT:return{...e,currentProduct:t.payload,loading:!1,error:null,status:`done`};case o.SET_RELATED_PRODUCTS:return{...e,relatedProducts:t.payload,status:`done`};case o.SETUP:return{...e,...t.payload};default:return e}},g=u(ee,h),_=d(`shopping_cart`),v={items:[],selectedAll:!1},te=(e,t)=>e.find(e=>e.id===t),ne=(e,t)=>{let n=_.get()??v;switch(t.type){case s.ADD_ITEM:{let{product:e,quantity:r=1}=t.payload,i=te(n.items,e.productId);if(i)return{...n,items:n.items.map(t=>t.id===e.productId?{...t,quantity:t.quantity+r}:t)};{let t={id:e.productId,title:e.title,image:e.image,price:parseInt(e.lprice),quantity:r,selected:!1};return{...n,items:[...n.items,t]}}}case s.REMOVE_ITEM:return{...n,items:n.items.filter(e=>e.id!==t.payload)};case s.UPDATE_QUANTITY:{let{productId:e,quantity:r}=t.payload;return{...n,items:n.items.map(t=>t.id===e?{...t,quantity:Math.max(1,r)}:t)}}case s.CLEAR_CART:return{...n,items:[],selectedAll:!1};case s.TOGGLE_SELECT:{let e=t.payload,r=n.items.map(t=>t.id===e?{...t,selected:!t.selected}:t),i=r.length>0&&r.every(e=>e.selected);return{...n,items:r,selectedAll:i}}case s.SELECT_ALL:{let e=n.items.map(e=>({...e,selected:!0}));return{...n,items:e,selectedAll:!0}}case s.DESELECT_ALL:{let e=n.items.map(e=>({...e,selected:!1}));return{...n,items:e,selectedAll:!1}}case s.REMOVE_SELECTED:return{...n,items:n.items.filter(e=>!e.selected),selectedAll:!1};case s.LOAD_FROM_STORAGE:return{...n,...t.payload};default:return n}},y=u(ne,v),re={cartModal:{isOpen:!1},globalLoading:!1,toast:{isVisible:!1,message:``,type:`info`}},ie=(e,t)=>{switch(t.type){case c.OPEN_CART_MODAL:return{...e,cartModal:{isOpen:!0}};case c.CLOSE_CART_MODAL:return{...e,cartModal:{isOpen:!1}};case c.HIDE_TOAST:return{...e,toast:{...e.toast,isVisible:!1}};case c.SHOW_TOAST:return{...e,toast:{isVisible:!0,message:t.payload.message,type:t.payload.type||`info`}};default:return e}},b=u(ie,re);function ae(){if(typeof window>`u`||!window.__INITIAL_DATA__)return!1;let e=window.__INITIAL_DATA__;console.log(`Restoring initial data:`,e);try{return(e.products||e.categories||e.totalCount!==void 0)&&g.dispatch({type:o.SETUP,payload:{products:e.products??[],categories:e.categories??{},totalCount:e.totalCount??0,loading:!1,error:null,status:`done`}}),e.currentProduct&&g.dispatch({type:o.SET_CURRENT_PRODUCT,payload:e.currentProduct}),e.relatedProducts&&g.dispatch({type:o.SET_RELATED_PRODUCTS,payload:e.relatedProducts}),x(),!0}catch(e){return console.error(`Failed to hydrate store from SSR data:`,e),x(),!1}}function x(){try{delete window.__INITIAL_DATA__}catch{window.__INITIAL_DATA__=void 0}}function S(){let e=g.getState();return e.status!==`idle`&&e.products.length>0}function C(e){let t=g.getState();return t.currentProduct&&t.currentProduct.productId===e}const w=`/front_6th_chapter4-1/vanilla/`,T=new m(w),E=new WeakMap,D={current:null,previous:null},oe={mount:null,unmount:null,watches:[],deps:[],mounted:!1},O=e=>(E.has(e)||E.set(e,{...oe}),E.get(e)),se=(e,t)=>!Array.isArray(e)||!Array.isArray(t)?!1:e.length===t.length?e.some((e,n)=>e!==t[n]):!0,ce=e=>{let t=O(e);t.mounted||(t.mount?.(),t.mounted=!0,t.deps=[])},le=e=>{let t=O(e);t.mounted&&=(t.unmount?.(),!1)},k=({onMount:e,onUnmount:t,watches:n}={},r)=>{let i=O(r);return typeof e==`function`&&(i.mount=e),typeof t==`function`&&(i.unmount=t),Array.isArray(n)&&(i.watches=typeof n[0]==`function`?[n]:n),(...e)=>{let t=D.current!==r;return D.current&&t&&le(D.current),D.previous=D.current,D.current=r,t?ce(r):i.watches&&i.watches.forEach(([e,t],n)=>{let r=e();se(r,i.deps[n])&&t(),i.deps[n]=Array.isArray(r)?[...r]:[]}),r(...e)}};function ue(e){let{productId:t,title:n,image:r,lprice:i,brand:a}=e,o=Number(i);return`
  ...
  `}const P=()=>typeof window>`u`,F=e=>P()?new URL(e,`http://localhost:${{}.PORT||5173}`):e;async function I(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(F(`/api/products?${s}`));return await c.json()}async function L(e){let t=await fetch(F(`/api/products/${e}`));return await t.json()}async function _e(){let e=await fetch(F(`/api/categories`));return await e.json()}const ve=async()=>{T.query={current:void 0},g.dispatch({type:o.SETUP,payload:{...h,loading:!0,status:`pending`}});try{let[{products:e,pagination:{total:t}},n]=await Promise.all([I(T.query),_e()]);g.dispatch({type:o.SETUP,payload:{products:e,categories:n,totalCount:t,loading:!1,status:`done`}})}catch(e){throw g.dispatch({type:o.SET_ERROR,payload:e.message}),e}},R=async(e=!0)=>{try{g.dispatch({type:o.SETUP,payload:{loading:!0,status:`pending`,error:null}});let{products:t,pagination:{total:n}}=await I(T.query),r={products:t,totalCount:n};if(e){g.dispatch({type:o.SET_PRODUCTS,payload:r});return}g.dispatch({type:o.ADD_PRODUCTS,payload:r})}catch(e){throw g.dispatch({type:o.SET_ERROR,payload:e.message}),e}},ye=async()=>{let e=g.getState(),t=e.products.length<e.totalCount;!t||e.loading||(T.query={current:Number(T.query.current??1)+1},await R(!1))},z=e=>{T.query={search:e,current:1}},B=e=>{T.query={...e,current:1}},be=e=>{T.query={sort:e,current:1}},xe=e=>{T.query={limit:e,current:1}},V=async e=>{try{let t=g.getState().currentProduct;if(e===t?.productId){t.category2&&await H(t.category2,e);return}g.dispatch({type:o.SETUP,payload:{...h,currentProduct:null,loading:!0,status:`pending`}});let n=await L(e);g.dispatch({type:o.SET_CURRENT_PRODUCT,payload:n}),n.category2&&await H(n.category2,e)}catch(e){throw console.error(`상품 상세 페이지 로드 실패:`,e),g.dispatch({type:o.SET_ERROR,payload:e.message}),e}},H=async(e,t)=>{try{let n={category2:e,limit:20,page:1},r=await I(n),i=r.products.filter(e=>e.productId!==t);g.dispatch({type:o.SET_RELATED_PRODUCTS,payload:i})}catch(e){console.error(`관련 상품 로드 실패:`,e),g.dispatch({type:o.SET_RELATED_PRODUCTS,payload:[]})}},Se=()=>{try{let e=_.get();e&&y.dispatch({type:s.LOAD_FROM_STORAGE,payload:e})}catch(e){console.error(`장바구니 로드 실패:`,e)}},U=()=>{try{let e=y.getState();_.set(e)}catch(e){console.error(`장바구니 저장 실패:`,e)}},W=(e,t=1)=>{y.dispatch({type:s.ADD_ITEM,payload:{product:e,quantity:t}}),U(),b.dispatch({type:c.SHOW_TOAST,payload:{message:`장바구니에 추가되었습니다`,type:`success`}}),setTimeout(()=>{b.dispatch({type:c.HIDE_TOAST})},3e3)},Ce=e=>{y.dispatch({type:s.REMOVE_ITEM,payload:e}),U()},G=(e,t)=>{y.dispatch({type:s.UPDATE_QUANTITY,payload:{productId:e,quantity:t}}),U()},we=e=>{y.dispatch({type:s.TOGGLE_SELECT,payload:e}),U()},K=()=>{y.dispatch({type:s.SELECT_ALL}),U()},q=()=>{y.dispatch({type:s.DESELECT_ALL}),U()},J=()=>{y.dispatch({type:s.REMOVE_SELECTED}),U(),b.dispatch({type:c.SHOW_TOAST,payload:{message:`선택된 상품들이 삭제되었습니다`,type:`info`}}),setTimeout(()=>{b.dispatch({type:c.HIDE_TOAST})},3e3)},Y=()=>{y.dispatch({type:s.CLEAR_CART}),U(),b.dispatch({type:c.SHOW_TOAST,payload:{message:`장바구니가 비워졌습니다`,type:`info`}}),setTimeout(()=>{b.dispatch({type:c.HIDE_TOAST})},3e3)},X=({headerLeft:e,children:t})=>{let n=y.getState(),{cartModal:r,toast:i}=b.getState(),a=n.items.length,o=`
  ...
  `},Te=(e,t)=>{let{search:n,limit:r,sort:i,category1:a,category2:o}=t,{products:s,loading:c,error:l,totalCount:u,categories:d}=e,f={category1:a,category2:o},p=s.length<u;return X({headerLeft:`<h1 class="text-xl font-bold text-gray-900">
        <a href="/" data-link>쇼핑몰</a>
      </h1>`,children:`
      <!-- 검색 및 필터 -->
      ${pe({searchQuery:n,limit:r,sort:i,category:f,categories:d})}
      
      <!-- 상품 목록 -->
      <div class="mb-6">
        ${he({products:s,loading:c,error:l,totalCount:u,hasMore:p})}
      </div>
    `.trim()})},Ee=k({onMount:()=>{S()||ve()},watches:[()=>{let{search:e,limit:t,sort:n,category1:r,category2:i}=T.query;return[e,t,n,r,i]},()=>R(!0)]},()=>{let e=g.getState(),t=T.query;return Te(e,t)}),De=({error:e})=>`
...
`;function Oe({product:e,relatedProducts:t=[]}){let{productId:n,title:r,image:i,lprice:a,brand:o,description:s=``,rating:c=0,reviewCount:l=0,stock:u=100,category1:d,category2:f}=e,p=Number(a),m=[];return d&&m.push({name:d,category:`category1`,value:d}),f&&m.push({name:f,category:`category2`,value:f}),`
    <!-- 브레드크럼 -->
    ${m.length>0?`
      <nav class="mb-4">
    ...
    `:``}
  `}const ke=e=>{let{currentProduct:t,relatedProducts:n=[],error:r,loading:i}=e;return X({headerLeft:`<div class="flex items-center space-x-3">
        <button onclick="window.history.back()" 
...
`:r&&!t?De({error:r}):Oe({product:t,relatedProducts:n})})},Ae=k({onMount:()=>{let e=T.params.id;C(e)||V(e)},watches:[()=>[T.params.id],()=>V(T.params.id)]},()=>{let e=g.getState();return ke(e)}),je=()=>X({headerLeft:M(),children:`<div class="text-center my-4 py-20 shadow-md p-6 bg-white rounded-lg">
